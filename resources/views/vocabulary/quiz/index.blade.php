                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="lesson_from" id="lesson_from" required
                                ...
                                @foreach($lessons as $lesson)
                                    <option value="{{ $lesson->id }}" {{ old('lesson_from') == $lesson->id || isset($_GET['lesson_from']) && $_GET['lesson_from'] == $lesson->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="lesson_to" id="lesson_to" required
                                ...
                                @foreach($lessons as $lesson)
                                    <option value="{{ $lesson->id }}" {{ old('lesson_to') == $lesson->id || isset($_GET['lesson_to']) && $_GET['lesson_to'] == $lesson->id ? 'selected' : '' }}>
                                        Lesson {{ $lesson->chapter }}
                                    </option>
                                @endforeach
                            </select>
